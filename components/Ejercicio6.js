...
const Ejercicio6 = () => {
  ...
  return (
    <View style={styles.content}>
      <Text style={styles.titulo}>Ejercicio 6 la Mitad</Text>
      <View>
        <TextInput
      ...
      {(num1 < num3) & (num3 < num2) ? (
        <Text style={styles.respuesta}>El numero de la mitad es: {num3}</Text>
      ) : null}
      {(num2 < num1) & (num1 < num3) ? (
        <Text style={styles.respuesta}>El numero de la mitad es: {num1}</Text>
      ) : null}
      {(num2 < num3) & (num3 < num1) ? (
        <Text style={styles.respuesta}>El numero de la mitad es: {num1}</Text>
      ) : null}
      ...
      {(num1 < num2) & (num2 < num3) ? (
        <Text style={styles.respuesta}>El numero de la mitad es: {num2}</Text>
      ) : null}
      {(num3 < num2) & (num2 < num1) ? (
        <Text style={styles.respuesta}>El numero de la mitad es: {num2}</Text>
      ) : null}
